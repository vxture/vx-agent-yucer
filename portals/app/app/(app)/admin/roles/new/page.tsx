...
export default async function NewRolePage() {
  const { ADMIN_TEXT, DOMAIN_LABEL, PERMISSION_LABEL, PERMISSION_TREE_TEXT, ROLE_TEXT } = await getMessages();
  ...
  return (
    <ViewLayout>
      ...
      />
      <ViewHeader icon="user-circle" title={ROLE_TEXT.newRole} description={ROLE_TEXT.formWhy} />
      <RoleForm
        isNew
        code=""
        name=""
