...
export const en: Dictionary = {
  ...
  ROLE_TEXT: {
    ...
    detailsColHeld: "Held",
    detailsEdit: "Edit",
    detailsEditTitle: (name: string) => `${name} · edit permissions`,
    detailsEditWhy: "Ticking an operation grants the permission it needs; operations needing the same permission change together. The drawer stays open after saving.",
    detailsSave: "Save",
    detailsSaved: (name: string, n: number, total: number) => `"${name}" saved, holding ${n} of ${total} permissions`,
    ...
    resetAllButton: "Reset presets",
    resetAllTitle: "Reset the preset roles",
