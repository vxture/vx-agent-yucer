...
export const en: Dictionary = {
  ...
  PLANNING_TEXT: {
    ...
    divisionPickNone: "No province matches",
    divisionSearch: "Search a province, its short name, or a standard region",
    divisionChosen: (n: number) => `${n} chosen`,
    divisionHintPresets: (five: string, seven: string) => `5-way ${five} · 7-way ${seven}`,
    ...
    scopeWhy: "The frame regions are carved in: the world by country, the country by province, one province by city.",
    ...
    divisionMovedTitle: (n: number) => `${n} province(s) will move in from other regions`,
