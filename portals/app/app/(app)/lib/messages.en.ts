...
export const en: Dictionary = {
  ...
  CATALOG_ERROR: {
    ...
    status_disabled: "That status is switched off; enable it before moving products in",
    born_shelved: "A product cannot be created already in a retired-behaviour status",
    system_status: "The three system statuses never delete - rename them, or disable development",
    status_in_use: "Products still carry this status - move them first",
    status_load_bearing: "On sale and Retired carry quoting and shelving; they cannot be disabled",
    system_behavior_fixed: "A system status's behaviour is itself and cannot be chosen",
    behavior_required: "Pick the behaviour - it decides how the rules read this status",
    product_in_use:
  ...
  CATALOG_TEXT: {
    ...
    typesWhy:
      "Types are the workspace's own vocabulary. Products reference them by code, so a type is retired, never deleted - old products still render.",
    typeCode: "Type code",
    typeName: "Type name",
    ...
    statusesWhy:
      "Statuses are this workspace's vocabulary; each anchors a behaviour the rules read - only active-behaviour statuses are quotable.",
    addStatus: "New status",
    saveStatus: "Save status",
    colBehavior: "Behaviour",
    behaviorHint: "The behaviour is chosen at creation and never changes - a quotable status cannot silently stop being quotable",
    moveToStatus: (label: string) => `Move to "${label}"`,
    statusDeleteConsequence: "Deletion is permanent. The three system statuses never delete; refused while products carry the status.",
    statusMeaningDev: "The birth state: real, present in plans, not quotable - and there is no way back into it.",
    statusMeaningActive: "The one quotable state. Launching, and reinstating after retirement, both land here.",
    statusMeaningRetired: "Shelved, not deleted: reinstate any time, every historical reference kept.",
    solutions: "Solutions",
    solutionsWhy:
