...
export const en: Dictionary = {
  ...
  DEAL_SCORE_TEXT: {
    title: "Deal score",
    why: "The 0-100 score on the deal dossier: seven factors, each 0-100, averaged with the weights here. A stage with no exit criteria leaves that factor out and spreads its weight over the rest.",
    sum: (n: number) => `Weights total ${n}/100`,
    weightsLabel: "Factor weights",
    weightsHint: "The seven weights must add up to 100. A weight of 0 leaves the factor out.",
    factor: {
      exit: "Exit criteria",
      chain: "Buying group",
      stage: "Momentum",
    ...
    factorHow: {
      exit: "met / total at this stage",
      chain: "steady 100 · watch · risk 0",
      stage: "steady 100 · watch · risk 0",
      recency: "days since the last touch",
      commitment: "steady 100 · watch · risk 0",
      forecast: "steady 100 · watch · risk 0",
      price: "steady 100 · watch · risk 0",
    } as Record<string, string>,
    watchLabel: "Watch score",
    watchHint: "What a factor scores when its verdict is watch (steady 100, risk 0)",
    recentLabel: "Recent within (days)",
    recentHint: "Touched within this many days: engagement 100",
    quietLabel: "Quiet after (days)",
    quietHint: "Untouched this long: 0; linear in between",
    save: "Save",
    reset: "Reset to defaults",
    formula: "Score = Σ(weight × factor) ÷ Σ weight",
    ...
    noConcern: "Every factor at full marks",
