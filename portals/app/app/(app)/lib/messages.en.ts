...
export const en: Dictionary = {
  ...
  CATALOG_ERROR: {
    ...
    development_is_birth_state:
      "In development is a birth state: a product starts there, and cannot slide back",
    product_in_use:
  ...
  CATALOG_TEXT: {
    ...
    settingsLink: "Catalogue settings",
    ...
    settingsWhy: "What is configured here is the product SYSTEM - the type vocabulary and status semantics - not any one product.",
    ...
    typeCode: "Type code",
    typeName: "Type name",
    typeCodeHint: "The code is the anchor and cannot change; saving the same code again renames rather than adding",
    addType: "Save type",
    typeSaved: "Saved",
    typeRetire: "Retire",
    ...
    statusesWhy:
      "A status carries behaviour - only On sale is quotable - so the three are fixed by the system, not configurable.",
