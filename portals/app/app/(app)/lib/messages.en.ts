...
export const en: Dictionary = {
  ...
  ACCOUNT_TEXT: {
    ...
    panoramaLayerL2: "Relationship Assets",
    panoramaLayerL3: "Growth Positions",
    panoramaLayerL4: "Installed Base",
    panoramaLayerL5: "Account Assessment",
    panoramaLayerL6: "Battle Plan",
    panoramaLayerEV: "Evidence Base",
    panoramaCapCore: "Core capabilities",
    panoramaCapHigh: "Premium tier",
    panoramaCapDesigned: "Designed",
    capOrgUnitBasic: "CRUD + tiering + collaborators",
    capOrgUnitPro: "Relationship graph",
    capContactBasic: "CRUD + sorting + follow-up recency",
    capContactPro: "Decision chain roles + stance + influence",
    capChainBasic: "Coverage stats",
    capChainPro: "Reachability analysis + four-role mapping",
    capHealthBasic: "Five factors (incl. renewal) + status label + top issue",
    capHealthPro: "Why it changed + peer benchmark + risk types",
    capDealBasic: "Deal list + stage + amount (read-only ref D6)",
    ...
    capPlanBasic: "Pending proposal display (the memo is in the right-hand assistant)",
    ...
    capCommitBasic: "Create + both directions + close with evidence / missed / waived (a promise is never edited - that would rewrite history)",
