...
const KNOWN_UNWIRED: Record<string, string> = {
  // `account.setAccountParent` LEFT THIS LIST on 2026-09-15: the customer
  // detail page now carries AccountParentPanel, which calls
  // setAccountParentAction - the click-through incr/0025 (ADR-024 batch B)
  // had been waiting on since the column, the grant and the cycle guard
  // shipped.
