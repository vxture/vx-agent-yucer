...
SELECT t.id, v.code, v.kind, v.name, v.ord
  FROM (VALUES
  ('group_large', 'hq', NULL, 'headquarters', '集团总部', 1),
  ('group_large', 'bu1', 'hq', 'division', '事业部一', 2),
  ...
  ('group_large', 'bu2', 'hq', 'division', '事业部二', 12),
  ...
  ('national_medium', 'hq', NULL, 'headquarters', '总部', 1),
  ('national_medium', 'north', 'hq', 'region', '华北大区', 2),
  ('national_medium', 'north_team1', 'north', 'team', '销售一部', 3),
  ('national_medium', 'northeast', 'hq', 'region', '东北大区', 4),
  ('national_medium', 'northeast_team1', 'northeast', 'team', '销售一部', 5),
  ('national_medium', 'east', 'hq', 'region', '华东大区', 6),
  ('national_medium', 'east_team1', 'east', 'team', '销售一部', 7),
  ('national_medium', 'central', 'hq', 'region', '华中大区', 8),
  ('national_medium', 'central_team1', 'central', 'team', '销售一部', 9),
  ('national_medium', 'south', 'hq', 'region', '华南大区', 10),
  ('national_medium', 'south_team1', 'south', 'team', '销售一部', 11),
  ('national_medium', 'southwest', 'hq', 'region', '西南大区', 12),
  ('national_medium', 'southwest_team1', 'southwest', 'team', '销售一部', 13),
  ('national_medium', 'northwest', 'hq', 'region', '西北大区', 14),
  ('national_medium', 'northwest_team1', 'northwest', 'team', '销售一部', 15),
  ('small_team', 'hq', NULL, 'headquarters', '总部', 1),
  ('small_team', 'sales', 'hq', 'team', '销售团队', 2),
  ('small_team', 'presales', 'hq', 'team', '售前团队', 3),
  ('small_team', 'delivery', 'hq', 'team', '交付团队', 4)
