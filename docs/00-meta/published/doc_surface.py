...
DOMAINS = [
    ("战略武备域", "打什么仗，拿什么打", "市场战略 · 产品目录", "解决方案 · 产品定价（同页分段）· 细分市场"),
    ("作战部署域", "打谁，谁去打，背多少", "销售规划", "销售区域 · 重点客户 · 预测口径"),
    ("战场侦察域", "怎么把火力变成线索", "营销活动 · 商机智探", "线索分派"),
    ("阵地经营域", "这一仗怎么拿下", "客户管理 · 商机管理", "赢丢复盘（同页分段）· 报价管理"),
    ("战果沉淀域", "赢了之后钱怎么到账", "项目交付", "回款管理（同页分段）· 合同续约"),
]
...
<strong>赢丢复盘</strong>和<strong>回款管理</strong>标成开发中，而两者都已上线：
