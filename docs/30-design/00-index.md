...
| `design_yucer_150_panorama-agent.md` | 客户全景图智能体：六级阶梯与授权边界、ADR-003 的线落在哪、必须说「不知道」的三种情形、代办的三重同意 |
| `design_yucer_160_panorama-benchmark.md` | 客户全景图对标：四条方法论基线各取一段、页面级永不做与暂不做、差异化落点（对标**竞品**在 `20-specs/70`） |
